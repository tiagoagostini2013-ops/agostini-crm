...
// cliente depois da entrega, separado do funil de vendas acima. Só se
// aplica a leads em "Fechado" (base instalada) e só existe a partir do
// handoff (02/09/2026); leads fechados antes disso não têm
// `estagioPosVenda` preenchido e entram como "Entregue" por padrão na tela
// (ver PosVenda.jsx) até alguém arrastar o card.
export const POS_VENDA_STAGES = [
  { value: 'Entregue', color: '#007eb5', textColor: '#ffffff' },
  { value: 'Em Acompanhamento', color: '#fdab3d', textColor: '#3a2a05' },
